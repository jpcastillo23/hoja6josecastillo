...
public class Panel_fondo extends JPanel implements ActionListener {
	...
	private int counter=0,hora=0, minutos=0, segundos=0,fila1,fila2,fila3,fila4,hora2=0, minutos2=0, segundos2=0;
	...
	public Panel_fondo(Image fondo){
		 ...
		 */
		timer = new Timer ();
		timer.schedule(new innerClass(),0,7000);
	...
	class innerClass extends TimerTask{	
		public void run(){
			Panel_fondo.this.horaContinue();
			Panel_fondo.this.setHourImages();
		}		
	}
